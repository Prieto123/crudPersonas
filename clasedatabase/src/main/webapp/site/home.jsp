...
<head>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="site/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="site/assets/css/bootstrap/css/bootstrap.min.css">
    <!-- waves.css -->
    <link rel="stylesheet" href="site/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- themify icon -->
    <link rel="stylesheet" type="text/css" href="site/assets/icon/themify-icons/themify-icons.css">
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="site/assets/css/font-awesome-n.min.css">
    <link rel="stylesheet" type="text/css" href="site/assets/css/font-awesome.min.css">
    <!-- scrollbar.css -->
    <link rel="stylesheet" type="text/css" href="site/assets/css/jquery.mCustomScrollbar.css">
    <!-- Style.css -->
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">
                            <img class="img-fluid" src="site/assets/images/logo.png" alt="Theme-Logo" />
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="site/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="site/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="site/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <img src="site/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>John Doe</span>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="site/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                                                            ...
                                                            <table class="table table-hover m-b-0 without-header">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="site/assets/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="site/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
...
<![endif]-->
    ...
    <script type="text/javascript" src="site/assets/js/jquery-ui/jquery-ui.min.js "></script>
    <script type="text/javascript" src="site/assets/js/popper.js/popper.min.js"></script>
    <script type="text/javascript" src="site/assets/js/bootstrap/js/bootstrap.min.js "></script>
    <!-- waves js -->
    <script src="site/assets/pages/waves/js/waves.min.js"></script>
    <!-- jquery slimscroll js -->
    <script type="text/javascript" src="site/assets/js/jquery-slimscroll/jquery.slimscroll.js"></script>

    <!-- slimscroll js -->
    <script src="site/assets/js/jquery.mCustomScrollbar.concat.min.js "></script>

    <!-- menu js -->
    <script src="site/assets/js/pcoded.min.js"></script>
    <script src="site/assets/js/vertical/vertical-layout.min.js "></script>
